...
def process_rescates(df):
    ...
    if "Start At Local Dttm" not in df.columns:
...
def procesar_global(
    ...
    ins  = process_inspecciones(df_insp)
    abd  = process_abandonados(df_aband)
